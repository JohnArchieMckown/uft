...
int tcpopen(char *host, int flag, int mode) {
    ...
    if (hent == NULL) {
        ...
        hent->h_addr_list[1][0] = 0;
        hent->h_addr_list[1][1] = 0;
        hent->h_addr_list[1][2] = 0;
        hent->h_addr_list[1][3] = 0;
 ...
 *	  Date: 1995-Apr-19
 *
 *    See also: uft_getline.c, uft_putline.c
 */
